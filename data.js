 ...
 * 3年次 科目選択ナビ用データ
 *
 * 令和9年度 3年生用「科目選択のしおり」をもとにした試作用データ。
 * GitHub Pages上で index.html / app.js から読み込む想定。
 *
 * 注意：
 * - 大学の入試科目は年度・学部・方式により変わるため、本データだけで最終判断しない。
 * - 最終的な科目選択は、必ず科目選択のしおり、担任、教科担当、進路資料で確認する。
 * - 国公立理系の古典演習γについては、東大・京大理系志望者向けとして扱う。
 */
...
const PROFILES = [
  ...
  },
  {
    ...
    name: "推薦型・総合型選抜重視",
    shortName: "推薦・総合型重視",
    description: "課題探究演習などの活用を検討する型。ただし一般選抜に必要な科目との両立確認が必要。",
    category: "推薦・総合"
  }
];
...
const COURSE_SETS = [
  ...
  },
  {
    ...
    name: "世界史探究演習a＋b",
    courseIds: ["world_history_a", "world_history_b"],
    type: "required_pair",
  ...
  },
  {
    ...
    name: "日本史探究演習a＋b",
    courseIds: ["japanese_history_a", "japanese_history_b"],
    type: "required_pair",
  ...
  },
  {
    id: "public_ethics",
    name: "公共演習＋倫理",
    courseIds: ["public_studies", "ethics"],
    type: "public_pair",
  ...
  },
  {
    id: "public_politics",
    name: "公共演習＋政治・経済",
    courseIds: ["public_studies", "politics_economics"],
    type: "public_pair",
  ...
  },
  {
    ...
    name: "理科基礎演習2科目セット",
    courseIds: ["basic_physics", "basic_chemistry", "basic_biology"],
    type: "choose_exactly",
    requiredCount: 2,
  ...
  },
  {
    ...
    courseIds: ["world_history_a", "world_history_b", "japanese_history_a"],
    type: "exception",
    message: "世界史6単位＋日本史4単位の特例。日本史b相当部分は講習または自学で対応する。"
  },
  {
    id: "history_exception_japan6_world4",
    name: "歴史2科目特例：日本史6単位＋世界史4単位",
    courseIds: ["japanese_history_a", "japanese_history_b", "world_history_a"],
    type: "exception",
    message: "日本史6単位＋世界史4単位の特例。世界史b相当部分は講習または自学で対応する。"
  }
];
...
const EXCLUSIVE_GROUPS = [
  {
    id: "kobun_alpha_beta",
    name: "古典演習α／古典演習β",
    courseIds: ["kobun_alpha", "kobun_beta"],
    max: 1,
    severity: "error",
  ...
  },
  {
    ...
    courseIds: ["math_ia", "math_alpha", "math_beta"],
    max: 1,
    severity: "error",
  ...
  },
  {
    id: "math_gamma_delta",
    name: "数学演習γ／数学演習δ",
    courseIds: ["math_gamma", "math_delta"],
    max: 1,
    severity: "error",
  ...
  },
  {
    ...
    name: "数学Ⅲ／英語演習",
    courseIds: ["math_iii", "english_reading"],
    max: 1,
    severity: "error",
  ...
  },
  {
    ...
    courseIds: ["pe", "music", "art", "calligraphy"],
    max: 1,
    severity: "error",
  ...
  },
  {
    ...
    name: "英語探究演習／数学演習β",
    courseIds: ["english_inquiry", "math_beta"],
    max: 1,
    severity: "error",
...
const MODELS = {
  science_tokyo_kyoto: {
    ...
    name: "理系：東大・京大志望",
    required: ["math_iii", "math_gamma", "advanced_chemistry"],
    recommended: ["kobun_gamma"],
    selectableGroups: [
      {
        id: "science_main",
        label: "理科発展科目",
      ...
      },
      {
        ...
        required: true,
        options: [
          { label: "公共演習＋政治・経済", courseIds: ["public_studies", "politics_economics"] },
          { label: "公共演習＋倫理", courseIds: ["public_studies", "ethics"] }
        ],
        note: "理系で公共＋倫理を選ぶ場合、倫理は自学扱いになる点に注意。"
      },
      {
        id: "pe_or_art",
        label: "体育・芸術",
    ...
    lockedOut: ["kobun_alpha", "kobun_beta", "math_delta", "english_reading"],
    warnings: [
  ...
  science_national: {
    ...
    lockedOut: ["kobun_alpha", "kobun_beta", "kobun_gamma", "math_delta", "english_reading"],
    warnings: [
  ...
  science_private: {
    ...
    name: "理系：私立理系・薬・栄養系など",
    required: [],
    recommended: ["advanced_chemistry"],
    selectableGroups: [
      {
        id: "math_route",
        label: "数学ルート",
        ...
        required: true,
        options: [
          { label: "数Ⅲあり：数学Ⅲ＋数学演習γ", courseIds: ["math_iii", "math_gamma"] },
          { label: "数Ⅲなし：数学演習δ", courseIds: ["math_delta"] }
        ],
    ...
    lockedOut: ["kobun_alpha", "kobun_beta", "kobun_gamma"],
    warnings: [
  ...
  humanities_tokyo: {
    ...
    name: "文系：東大型",
    required: ["kobun_beta", "math_beta"],
    recommended: ["english_reading"],
    selectableGroups: [
      {
        id: "history_route",
        label: "地歴選択",
        ...
        required: true,
        options: [
          { label: "世界史6単位", courseIds: ["world_history_a", "world_history_b"] },
          { label: "日本史6単位", courseIds: ["japanese_history_a", "japanese_history_b"] },
          { label: "世界史6単位＋日本史4単位", courseIds: ["world_history_a", "world_history_b", "japanese_history_a"] },
          { label: "日本史6単位＋世界史4単位", courseIds: ["japanese_history_a", "japanese_history_b", "world_history_a"] },
          { label: "地理探究β", courseIds: ["geo_beta"] }
        ],
        note: "世界史＋日本史で受験する場合、どちらか一方のbしか受講できない場合があり、選択しないb相当範囲は自学となる。"
      },
      {
        id: "science_basics",
        label: "理科基礎演習",
        ...
        required: true,
        count: 2,
        options: ["basic_physics", "basic_chemistry", "basic_biology"]
      },
      {
        id: "pe_or_art",
        label: "体育・芸術",
    ...
    lockedOut: ["kobun_alpha", "math_ia", "math_alpha", "math_iii", "math_gamma", "math_delta", "english_inquiry"],
    warnings: [
  ...
  humanities_kyoto_hitotsubashi: {
    ...
    name: "文系：京大・一橋・旧帝大など難関国公立型",
    required: [],
    recommended: ["math_beta", "english_reading"],
    selectableGroups: [
      {
        id: "kobun_level",
        label: "古典演習",
        type: "single",
        required: true,
        options: ["kobun_alpha", "kobun_beta"],
      ...
      },
      {
        ...
        options: [
          ...
          { label: "日本史6単位", courseIds: ["japanese_history_a", "japanese_history_b"] },
          { label: "地理探究β", courseIds: ["geo_beta"] },
          { label: "地理探究α", courseIds: ["geo_alpha"] }
        ]
      },
      {
        id: "civics",
    ...
    lockedOut: ["math_ia", "math_alpha", "math_iii", "math_gamma", "math_delta"],
    warnings: [
  ...
  humanities_national: {
    ...
    name: "文系：国公立文系型",
    required: ["kobun_alpha"],
    recommended: ["math_alpha", "english_reading"],
    selectableGroups: [
      {
        id: "math_route",
        label: "数学選択",
    ...
    lockedOut: ["kobun_beta", "kobun_gamma", "math_beta", "math_iii", "math_gamma", "math_delta"],
    warnings: [
  ...
  nursing: {
    profileId: "nursing",
    name: "看護系志望",
    required: ["math_delta", "advanced_chemistry"],
    recommended: ["nursing_japanese", "english_reading"],
    selectableGroups: [
      {
        id: "science_main",
        label: "理科発展科目",
    ...
    lockedOut: ["kobun_alpha", "kobun_beta", "kobun_gamma", "math_iii", "math_gamma"],
    warnings: [
  ...
  private_humanities: {
    ...
    lockedOut: ["kobun_gamma", "math_iii", "math_gamma", "math_delta"],
    warnings: [
  ...
  recommendation: {
    ...
    selectableGroups: [
      {
        ...
        required: true,
        options: [
          { label: "国公立文系寄り", courseIds: ["kobun_alpha", "math_alpha"] },
          { label: "理系寄り：数Ⅲあり", courseIds: ["math_iii", "math_gamma", "advanced_chemistry"] },
          { label: "看護系寄り", courseIds: ["math_delta", "advanced_chemistry", "nursing_japanese"] }
        ],
        note: "推薦・総合型のみで考えず、一般選抜に必要な科目との両立を確認する。"
      },
      {
        id: "pe_or_art",
        label: "体育・芸術",
    ...
    lockedOut: [],
    warnings: [
      "課題探究演習は目的と課題意識が必要。事前に探究部担当教員へ相談する。",
      "推薦・総合型選抜を重視する場合でも、一般選抜で必要な科目を捨てない設計が必要。"
    ],
    selfStudy: []
  }
};
...
const RULES = {
  creditRange: {
    electiveMin: CONFIG.electiveMinCredits,
    electiveMax: CONFIG.electiveMaxCredits,
    totalMin: CONFIG.totalMinCredits,
    totalMax: CONFIG.totalMaxCredits,
  ...
  blockedByProfile: [
    {
      ...
      profileIds: ["science_national"],
      blockedCourseIds: ["kobun_alpha", "kobun_beta", "kobun_gamma"],
      severity: "error",
      message: "東大・京大以外の国公立理系志望者は、古典演習α・β・γを選択対象外とする。古典は共通テスト対応として自学・講習・質問で進める。"
    },
    {
      id: "science_private_no_kobun",
      profileIds: ["science_private"],
      blockedCourseIds: ["kobun_alpha", "kobun_beta", "kobun_gamma"],
      severity: "warning",
  ...
  requiredConsultation: {
    courseIds: COURSES.filter(course => course.consultRequired).map(course => course.id),
    severity: "warning",
  ...
  importantWarnings: [
    ...
    },
    {
      ...
      courseIds: ["world_history_a", "japanese_history_a"],
      severity: "warning",
      message: "世界史探究と日本史探究の2科目受験では、時間割上どちらか一方の探究演習b相当部分が自学となる可能性があります。"
    },
    {
      id: "science_public_ethics",
      profileIds: ["science_tokyo_kyoto", "science_national"],
      courseIds: ["public_studies", "ethics"],
      severity: "warning",
