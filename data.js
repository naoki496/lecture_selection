window.COURSE_SELECTOR_DATA = {
  ...
  "MODELS": {
    ...
    "science_private": {
      ...
      "selectableGroups": [
        ...
        {
          "id": "science_private_english_reading",
          "label": "数学Ⅲを選択しない場合の英語演習",
          "type": "single",
          "required": false,
          "options": [
            "english_reading"
          ],
          "note": "数学Ⅲを選択しない私立理系生徒は、志望校の入試科目に応じて英語演習を選択できる場合があります。数学Ⅲとは同時選択できません。"
        }
      ],
      "lockedOut": [
        "kobun_alpha",
      ...
      "warnings": [
        ...
        "数学Ⅲを選択しない私立理系生徒は、英語演習の必要性を志望校の入試科目で確認してください。"
      ],
      "selfStudy": []
    },
    "humanities_tokyo": {
  ...
  "RULES": {
    ...
    "blockedByProfile": [
      ...
      {
        "id": "english_inquiry_no_science_models",
        "profileIds": [
          "science_tokyo_kyoto",
          "science_national",
          "science_private"
        ...
        "severity": "error",
        "message": "英語探究演習は文系・文理型向けの講座であり、理系モデルでは原則選択対象外です。"
      }
    ],
    ...
    "importantWarnings": [
      ...
      {
        "id": "nursing_english_inquiry_consult",
        "profileIds": [
          "nursing"
        ],
        "courseIds": [
        ...
        "severity": "warning",
        "message": "看護系で英語探究演習を選択する場合は、志望校の英語試験内容と必要性を必ず確認してください。"
      }
    ]
  }
};
